...
import { Loader2, LogIn, Eye, EyeOff, Sparkles, ArrowRight } from "lucide-react";
    ...
    <Layout>
      <div className="min-h-screen bg-white flex items-center justify-center py-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-gradient-to-tl from-[#C5E500]/10 to-transparent" />
        </div>
        ...
        >
          <Card className="border border-gray-100 shadow-xl rounded-3xl overflow-hidden bg-white">
            ...
            <CardHeader className="text-center space-y-4 pt-8 pb-2">
              <motion.div 
                className="mx-auto bg-[#1B4D3E]/10 p-4 rounded-2xl w-fit"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <div>
                ...
                <CardDescription className="text-gray-500 mt-2">
                  Sign in to access your career history and personalized recommendations
                </CardDescription>
              </div>
            </CardHeader>
